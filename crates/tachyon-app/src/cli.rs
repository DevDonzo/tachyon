...
pub struct CliArgs {
    ...
    pub print_viewport: bool,
    pub search: Option<String>,
    pub regex: bool,
    pub case_insensitive: bool,
    pub max_hits: usize,
    pub search_chunk_lines: u64,
    pub search_batch_hits: usize,
    pub print_search_hits: bool,
    pub print_render_plan: bool,
    pub render_sim_frames: u32,
    pub max_glyph_uploads: usize,
    pub trace_json: Option<PathBuf>,
    pub trace_window_start_ns: Option<u64>,
    pub trace_window_end_ns: Option<u64>,
    pub trace_max_spans: usize,
    pub print_trace_spans: bool,
    pub print_trace_tracks: bool,
}
...
impl Default for CliArgs {
    fn default() -> Self {
        Self {
            ...
            jump_line: None,
            scroll_lines: 0,
            print_viewport: false,
            search: None,
            regex: false,
            case_insensitive: false,
            max_hits: 500,
            search_chunk_lines: 8192,
            search_batch_hits: 128,
            print_search_hits: false,
            print_render_plan: false,
            render_sim_frames: 1,
            max_glyph_uploads: 256,
            trace_json: None,
            trace_window_start_ns: None,
            trace_window_end_ns: None,
            trace_max_spans: 500,
            print_trace_spans: false,
            print_trace_tracks: false,
        }
    }
}
